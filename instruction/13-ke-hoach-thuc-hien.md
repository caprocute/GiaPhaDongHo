...
- [x] Admin donation / events / media / scholarship / moderation: **parity mockup** tương ứng (`admin-*.html`) + bỏ empty demo — *donation + events (KPI/card/RSVP/checklist) xong; media/scholarship/moderation còn*
