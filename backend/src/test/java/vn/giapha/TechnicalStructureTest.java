...
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .whereLayer("Service").mayOnlyBeAccessedByLayers("Web", "Config", "Genealogy", "Cms", "Iam", "Search", "Moderation", "Donation")
        .whereLayer("Security").mayOnlyBeAccessedByLayers("Config", "Service", "Web", "Genealogy", "Cms", "Iam", "Search", "Moderation", "Donation")
        .whereLayer("Persistence").mayOnlyBeAccessedByLayers("Service", "Security", "Web", "Config", "Genealogy", "Cms", "Iam", "Search", "Moderation", "Donation")
        .whereLayer("Domain").mayOnlyBeAccessedByLayers("Persistence", "Service", "Security", "Web", "Config", "Genealogy", "Cms", "Iam", "Search", "Moderation", "Donation")
        .whereLayer("Core").mayOnlyBeAccessedByLayers("Web", "Service", "Security", "Config", "Genealogy", "Cms", "Iam", "Search", "Moderation", "Donation", "Core")
