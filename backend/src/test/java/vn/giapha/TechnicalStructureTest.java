...
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .whereLayer("Service").mayOnlyBeAccessedByLayers("Web", "Config", "Genealogy", "Cms", "Iam", "Search", "Moderation")
        .whereLayer("Security").mayOnlyBeAccessedByLayers("Config", "Service", "Web", "Genealogy", "Cms", "Iam", "Search", "Moderation")
        .whereLayer("Persistence").mayOnlyBeAccessedByLayers("Service", "Security", "Web", "Config", "Genealogy", "Cms", "Iam", "Search", "Moderation")
        .whereLayer("Domain").mayOnlyBeAccessedByLayers("Persistence", "Service", "Security", "Web", "Config", "Genealogy", "Cms", "Iam", "Search", "Moderation")
        .whereLayer("Core").mayOnlyBeAccessedByLayers("Web", "Service", "Security", "Config", "Genealogy", "Cms", "Iam", "Search", "Moderation", "Core")
