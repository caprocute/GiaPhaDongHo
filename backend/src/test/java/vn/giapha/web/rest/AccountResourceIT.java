...
import static vn.giapha.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static vn.giapha.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static vn.giapha.test.util.OAuth2TestUtil.testAuthenticationToken;
